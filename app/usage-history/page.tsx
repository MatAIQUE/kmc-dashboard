                        ...
                        <div className="py-4 px-6">
                            ...
                            <div className="mb-6">
                                <div className="relative flex items-center w-full md:w-1/4">
                                    ...
                                    <input type="text" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 md:text-xs text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Name, ID, Locker"/>
                                </div>                               
                            </div>
